...
from funciones import (
    ...
    calibrar_modelo_regresion_lineal,
    OLS_predicciones_residuos_train,
    OLS_predicciones_residuos_test,
...
def flujo_previo_ABC(region, ruta_datos_precipitacion = 'tablas_precipitaciones.parquet', print_comprobacion_dimensiones = False):
    ...
    model_OLS_region = calibrar_modelo_regresion_lineal(datos_region_train)

    datos_region_train = OLS_predicciones_residuos_train(datos_region_train, model_OLS_region)
    datos_region_test = OLS_predicciones_residuos_test(datos_region_test, poly_region, scaler_region, model_OLS_region)
