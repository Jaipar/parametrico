...
columnas_matrix_diseno = ['lat', 'lon', 'sin_1', 'cos_1', 'sin_2', 'cos_2', 'ENSO']
...
def procesamiento_matriz_diseno(datos, poly, scaler):
    ...
    # Selección columnas para la matriz diseño
    X_full = X_full[columnas_matrix_diseno]
...
def corrida_simulacion(real, m, nsites, design_mat, dist_mat, nsimul, seed):
    ...
    for _ in range(nsimul):
        # gamma_medias = np.array([4.9461,-0.1582,-0.1070,-1.1413,-0.6454,-0.6193,0.2267,-0.1289,0.0571])
        ...
        simulaciones = [X_train_auxiliar_D2, X_train_auxiliar_D3, X_train_auxiliar_D4]
