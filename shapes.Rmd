...
for (x_anno in 0:24) {
  lista_anual_norte[[x_anno+1]] <-
    get_chirps(
      data.frame( lon = resumen_coords_norte$lon,
                  lat = resumen_coords_norte$lat 
                ),
      dates = c(
        paste0(x_anno + 2000,"-01-01"),
        paste0(x_anno + 2000,"-12-31")
      ),
      server = "ClimateSERV"
    )
}
names(lista_anual_norte) <- "2000":"2024"
...
for (x_anno in 0:24) {
  lista_anual_norte[[x_anno+1]] <-
    get_chirps(
      data.frame( lon = resumen_coords_santos$lon,
...
names(lista_anual_santos) <- "2000":"2024"
