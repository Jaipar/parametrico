...
rng_precipitaciones <- c(0, 5000)

# Paleta de color para precipitaciones anuales
pal_precipitaciones <- colorNumeric("YlGnBu", domain = rng_precipitaciones)
...
# Grafico comparativo de precipitaciones anuales promedio entre regiones
